...
const resources = {
  he: {
    translation: {
      ...
      text: {
        info: 'שירות הקבוצות של אמן.\nבעזרת Friends ניתן ליצור קבוצות עניין הן מבצעיות והן אישיות, ולהוסיף משתמשים לקבוצות קיימות ובכך להקל על המשתמש בעבודה היומיומית (ארגון פגישות, עבודה משותפת על פרויקטים, שיתוף קבצים ועוד).\nבעזרת שירות  Friends נוכל לעבוד באופן מרוכז מול אנשי קשר מרובים בעזרת השימוש בקבוצה מבלי שנצטרך להזין כל איש קשר בנפרד.שירות Friends מאפשר שירות API  חיצוני ובכך ניתן לגשת לשירות גם דרך אפליקציות נוספות ולנהל בהן קבוצות.',
