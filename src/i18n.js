  ...
  he: {
    translation: {
      ...
      text: {
        ...
        בעזרת שירות Friends נוכל לעבוד באופן מרוכז מול אנשי קשר\n מרובים בעזרת השימוש בקבוצה מבלי שנצטרך להזין כל איש קשר בנפרד.\n שירות Friends מאפשר שירות API חיצוני ובכך ניתן לגשת לשירות גם דרך\n אפליקציות נוספות ולנהל בהן קבוצות.`,
